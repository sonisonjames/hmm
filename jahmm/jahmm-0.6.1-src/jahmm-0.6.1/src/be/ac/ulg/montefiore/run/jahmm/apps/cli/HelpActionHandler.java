...
public class HelpActionHandler extends ActionHandler
{
	public void act()
	{
		...
		s += "-N <num>\n\tThe number of sequences to generate. This is required\n" +
		"\targument for generate. Default is " + Arguments.N_SEQ.getDefault() + "\n";
		
		s += "-L <num>\n\tThe length of each sequence generated. This is required\n" +
				"\targument for generate. Default is " + Arguments.N_SEQLEN.getDefault() + "\n";
		...
		"standard output.\n";
		s += "-oss <output_state_file>\n\tA state sequences output file.\n  Default is " +
				"standard output.\n";
		s += "-opp <output_prediction_probability_file>\n\tPrediction probabilities for each state.\n  Default is " +
				"standard output.\n";
		...
		s += "-LL <nb>\n\tThe length of the learn sequence." + 
		" The remaining sequence is used for prediction " +  " Default is " +
		Arguments.N_LEARN_SEQLEN.getDefault() + ".\n";
		
		s += "-D \tTurn on DEBUG messages\n";
