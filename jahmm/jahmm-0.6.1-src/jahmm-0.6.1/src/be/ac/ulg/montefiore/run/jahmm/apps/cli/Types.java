...
implements RelatedObjs<ObservationInteger>
{
	...
	public Pair<ArrayList<List<ObservationInteger>>, ArrayList<List<ObservationInteger>>> readSequences(Reader reader, int learnSeqLen)
...
implements RelatedObjs<ObservationReal>
{
	...
	{
		this.opdf = opdf;
		if (Arguments.NB_GAUSSIANS.getIsSet())
	...
	public Pair<ArrayList<List<ObservationReal>>, ArrayList<List<ObservationReal>>> readSequences(Reader reader, int learnSeqLen)
	throws FileFormatException, IOException
	{
		return ObservationSequencesReader.readSequences(observationReader(),
				reader, learnSeqLen);
...
implements RelatedObjs<ObservationVector>
{
	...
	public ObservationWriter<ObservationVector> observationWriter()
	{
	...
	public Pair<ArrayList<List<ObservationVector>>, ArrayList<List<ObservationVector>>> readSequences(Reader reader, int learnSeqLen)
	throws FileFormatException, IOException
	{
		return ObservationSequencesReader.readSequences(observationReader(),
				reader, learnSeqLen);
