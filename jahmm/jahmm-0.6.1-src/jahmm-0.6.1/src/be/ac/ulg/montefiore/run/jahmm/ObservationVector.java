...
{	
	 ...
	 */
	public ObservationVector(int dimension, Integer state)
	{
		if (dimension <= 0)
	 ...
	 */
	public ObservationVector(double[] value, Integer state)
	{
		this(value.length, state);
	...
	public ObservationVector plus(ObservationVector o)
	{
		...
		ObservationVector s = new ObservationVector(dimension(), state);
	...
	public ObservationVector minus(ObservationVector o)
	{
		...
		ObservationVector d = new ObservationVector(dimension(), state);
		for (int i = 0; i < dimension(); i++)
		{
	...
	{
		return new ObservationVector(value, state);
	}


	@Override
	public String stateToString(NumberFormat numberFormat) {
