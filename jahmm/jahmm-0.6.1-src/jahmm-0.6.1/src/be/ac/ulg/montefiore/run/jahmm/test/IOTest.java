...
extends TestCase
{
	...
	{/*
		...
		Pair<ArrayList<? extends List<ObservationInteger>>, ArrayList<? extends List<ObservationInteger>>> 
		sequences =
			ObservationSequencesReader.
			readSequences(new ObservationIntegerReader(), reader, 1000);
		reader.close();
	...
	{/*
		...
		List<? extends List<ObservationVector>> sequences =
			ObservationSequencesReader.
			readSequences(new ObservationVectorReader(), reader, 1000);
		reader.close();
