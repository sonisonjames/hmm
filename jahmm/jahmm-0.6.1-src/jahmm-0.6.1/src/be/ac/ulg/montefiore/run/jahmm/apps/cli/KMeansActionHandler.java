...
extends ActionHandler
{
	...
	AbnormalTerminationException
	{
		...
		learn(nbStates, Types.relatedObjs(), reader, learnSeqLen, writer);
	...
	learn(int nbStates, RelatedObjs<O> relatedObjs, Reader reader, 
			int learnSeqLen, Writer writer)
	throws IOException, FileFormatException
	{
		OpdfFactory<? extends Opdf<O>> opdfFactory = relatedObjs.opdfFactory();
		Pair<ArrayList<List<O>>, ArrayList<List<O>>> seqs = relatedObjs.readSequences(reader, learnSeqLen);
