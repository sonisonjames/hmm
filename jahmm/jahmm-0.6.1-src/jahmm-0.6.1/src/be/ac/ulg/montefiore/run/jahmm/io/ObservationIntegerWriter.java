...
{	
	...
	throws IOException
	{
		writer.write(observation.value + sep + " ");
	}

	@Override
	public void write(ObservationInteger obs,
			Writer obsWriter, Writer seqWriter) throws IOException {
		obsWriter.write(obs.value + sep + " ");
		seqWriter.write(obs.state + sep +" ");
